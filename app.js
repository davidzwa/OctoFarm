...
const firmwareChecker = require("./server_src/runners/firmwareChecker");
...
const serverStart = async () => {
  try {
    ...
    await firmwareChecker.syncLatestOctoFarmRelease(
      false || process.env.OCTOFARM_PRERELEASE
    );
    firmwareChecker.checkReleaseAndLogUpdate();
